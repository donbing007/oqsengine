...
public class RedisTest {
    ...
    public void multiConsumerTest() throws InterruptedException {
        ...
        RedisClient redisClient1 = RedisClient.create("redis://localhost:6379");
        ...
        RedisClient redisClient2 = RedisClient.create("redis://localhost:6379");
        ...
        RedisClient redisClient3 = RedisClient.create("redis://localhost:6379");
