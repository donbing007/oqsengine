...
(
    ...
    `biz_type`    varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '业务标签，例如可以用来标识业务序列号的的对象字段,objectCode:fieldName',
    `begin_id`    bigint(20)                                                   NOT NULL COMMENT '号段起始ID',
    `max_id`      bigint(20)                                                   NOT NULL COMMENT '当前号段最大ID',
    `step`        int(11)                                                      NOT NULL COMMENT '号段增加的步长',
    `patten`      varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '自定义模式',
    `mode`        tinyint(4)                                                   NOT NULL COMMENT '1：顺序递增 2: 趋势递增',
