...
public class SumFunctionTest {
    ...
    public void excute() {
        ...
        Optional<IValue> a = sumFunction.excute(Optional.of(agg), ValueChange.build(0, o, n));
        System.out.println(a.get().getValue());

        DecimalValue agg11 = new DecimalValue(l2EntityClass.field("l0-decimal").get(), new BigDecimal("6000.10"));
        ...
        Optional<IValue> a11 = sumFunction.excute(Optional.of(agg11), ValueChange.build(0, o11, n11));
        ...
        Optional<IValue> a1 = sumFunction.excute(Optional.of(agg1), ValueChange.build(0, o1, n1));
        System.out.println(a1.get().getValue());

        LongValue agg2 = new LongValue(l2EntityClass.field("l1-long").get(), 6000);
        ...
        Optional<IValue> a2 = sumFunction.excute(Optional.of(agg2), ValueChange.build(0, o2, n2));
