 ...
 * @since 1.8
 */
public class StaticQueryExecutor extends AbstractStaticsTaskExecutor<Long, Optional<MapAttributeMasterStorageEntity>> {

    private boolean noDetail;

    public StaticQueryExecutor(String tableName, TransactionResource<Connection> resource, boolean noDetail) {
        this(tableName, resource, noDetail, 0);
    }

    public StaticQueryExecutor(
