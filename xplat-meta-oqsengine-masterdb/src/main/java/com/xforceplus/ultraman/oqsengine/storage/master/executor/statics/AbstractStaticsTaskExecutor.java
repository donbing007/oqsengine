package com.xforceplus.ultraman.oqsengine.storage.master.executor.statics;
 ...
 * @since 1.8
 */
public abstract class AbstractStaticsTaskExecutor<R, T> extends AbstractJdbcTaskExecutor<R, T> {

    private MetaManager metaManager;

    public AbstractStaticsTaskExecutor(String tableName, TransactionResource resource) {
        super(tableName, resource);
    }

    public AbstractStaticsTaskExecutor(String tableName, TransactionResource resource, long timeoutMs) {
