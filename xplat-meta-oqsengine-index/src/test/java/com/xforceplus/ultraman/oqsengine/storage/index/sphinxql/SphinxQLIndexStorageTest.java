...
//    }
//
//    private ManticoreStorageEntity create(Long id, Long entityId, Long commitId, Long tx) {
//        ManticoreStorageEntity entity = new ManticoreStorageEntity();
//        entity.setId(id);
...
//                try {
//                    ManticoreStorageEntity manticoreStorageEntity = create(e.id(), e.entityClass().id(), commitId, tx);
//                    storage.entityValueToStorage(manticoreStorageEntity, e.entityValue());
//                    storage.batchSave(Collections.singletonList(manticoreStorageEntity), false, false);
...
//                try {
//                    ManticoreStorageEntity manticoreStorageEntity =
//                        create(e.id(), e.entityClass().id(), commitId, tx);
//                    manticoreStorageEntity.setTime(e.time());
//                    if (e.maintainId() == taskId) {
//                        manticoreStorageEntity.setMaintainId(taskId);
//                    }
//                    storage.entityValueToStorage(manticoreStorageEntity, e.entityValue());
//                    storage.batchSave(Collections.singletonList(manticoreStorageEntity), false, false);
//                } catch (SQLException ex) {
