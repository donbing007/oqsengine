 ...
 */
public class GtEqNotMatchDecimalConditionQueryBuilderTest {
    ...
    public void testBuild() throws Exception {
        GtEqNotMatchDecimalConditionQueryBuilder builder = new GtEqNotMatchDecimalConditionQueryBuilder(storageStrategyFactory);
