 ...
 */
public class LtEqNotMatchDecimalConditionQueryBuilderTest {
    ...
    public void testBuild() throws Exception {
        LtEqNotMatchDecimalConditionQueryBuilder builder = new LtEqNotMatchDecimalConditionQueryBuilder(storageStrategyFactory);
