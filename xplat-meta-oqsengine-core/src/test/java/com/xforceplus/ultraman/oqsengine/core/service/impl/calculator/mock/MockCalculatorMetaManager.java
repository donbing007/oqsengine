    ...
    public static final IEntityClass L0_ENTITY_CLASS = OqsEntityClass.Builder.anEntityClass()
        ...
        .withField(EntityField.Builder.anEntityField()
            ...
            .withConfig(FieldConfig.Builder.anFieldConfig()
                ...
                .withSearchable(true)
                .withRequired(true)
                .withCalculationDefinition(StaticCalculation.Builder.anStaticCalculation()
                .build()).build())
            .build())
        .withField(EntityField.Builder.anEntityField()
        ...
        .withField(EntityField.Builder.anEntityField()
            ...
            .withConfig(FieldConfig.Builder.anFieldConfig()
                ...
                .withCalculationDefinition(Formula.Builder.anFormula()
                    ...
                    .withFailedPolicy(Formula.FailedPolicy.USE_FAILED_DEFAULT_VALUE)
                    .withArgs(Collections.singletonList("longValue1")).build()
                ).build())
            .build())
        .build();
    ...
    public static IEntityClass L1_ENTITY_CLASS = OqsEntityClass.Builder.anEntityClass()
        ...
        .withField(EntityField.Builder.anEntityField()
            ...
            .withConfig(FieldConfig.Builder.anFieldConfig()
                ...
                .withSearchable(true)
                .withRequired(true)
                .withCalculationDefinition(AutoFill.Builder.anAutoFill().build())
                .build())
            .build())
        .withField(EntityField.Builder.anEntityField()
                ...
                .withConfig(FieldConfig.Builder.anFieldConfig()
                    ...
                    .withCalculationDefinition(Formula.Builder.anFormula()
                        ...
                        .withFailedDefaultValue("0")
                        .withFailedPolicy(Formula.FailedPolicy.USE_FAILED_DEFAULT_VALUE)
                        .withArgs(Arrays.asList("longValue0", "stringAutoFill")).build()
                    ).build())
            .build())
