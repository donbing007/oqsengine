...
public class MockCalculatorMetaManager implements MetaManager {
    ...
    public static final IEntityClass L0_ENTITY_CLASS = OqsEntityClass.Builder.anEntityClass()
        ...
        .withField(EntityField.Builder.anEntityField()
            ...
            .withName("longValue0")
            .withConfig(FieldConfig.Builder.anFieldConfig().withLen(19).withSearchable(true).withRequired(true).build())
    ...
    public static IEntityClass L1_ENTITY_CLASS = OqsEntityClass.Builder.anEntityClass()
        ...
        .withField(EntityField.Builder.anEntityField()
            ...
            .withName("dateValue0")
            .withConfig(FieldConfig.Builder.anFieldConfig().withLen(40).withSearchable(true).withRequired(true).build())
            .withCalculator(Calculator.Builder.anCalculator()
                .withCalculateType(Calculator.Type.FORMULA)
                .withLevel(1)
                .withExpression("now()")
        ...
        .withField(EntityField.Builder.anEntityField()
            ...
            .withConfig(FieldConfig.Builder.anFieldConfig().withLen(256).withSearchable(true).withRequired(true).build())
            .withCalculator(Calculator.Builder.anCalculator()
