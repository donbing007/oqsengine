...
public class SphinxConsumerServiceTest extends CDCAbstractContainer {
    ...
    public void overBatchTest2() throws SQLException {
        try {
            ...
            CanalEntry.Entry fRanDom_1 = buildRow(RANDOM_INSERT_1, 0, Long.MAX_VALUE - 1, true, 1, commitId, "false", EXPECTED_ATTR_INDEX_1, 1);
            entries.add(fRanDom_1);

            addExpectCount(commitId);

            //  build child
            CanalEntry.Entry cEntryUnCommit = buildRow(EXPECTED_CREF, 1, Long.MAX_VALUE - 2, true, 1, commitId, "false", EXPECTED_ATTR_INDEX_2, 1);
         ...
         */
            //  build father
            CanalEntry.Entry fEntryUnCommit = buildRow(EXPECTED_PREF, 1, Long.MAX_VALUE, true, 1, commitId, "false", EXPECTED_ATTR_INDEX_0, 1);
            ...
            //  build delete
            CanalEntry.Entry cDeleted = buildRow(EXPECTED_DELETED, 1, Long.MAX_VALUE, true, 1, commitId, "false", EXPECTED_ATTR_INDEX_0, 1);
            ...
            //  random 2
            CanalEntry.Entry fRanDom_2 = buildRow(RANDOM_INSERT_2, 1, Long.MAX_VALUE, true, 1, commitId, "false", EXPECTED_ATTR_INDEX_0, 1);
    ...
    private void build(List<CanalEntry.Entry> entries, long commitId) {
        //  random 1
        CanalEntry.Entry fRanDom_1 = buildRow(RANDOM_INSERT_1, 1, Long.MAX_VALUE - 1, true, 1, commitId, "false", EXPECTED_ATTR_INDEX_1, 1);
        ...
        //  build delete
        CanalEntry.Entry cDeleted = buildRow(EXPECTED_DELETED, 1, Long.MAX_VALUE - 2, true, 1, commitId, "false", EXPECTED_ATTR_INDEX_2, 1);
        entries.add(cDeleted);

        addExpectCount(commitId);

        //  random 2
        CanalEntry.Entry fRanDom_2 = buildRow(RANDOM_INSERT_2, 1, Long.MAX_VALUE - 2, true, 1, commitId, "false", EXPECTED_ATTR_INDEX_2, 1);
        entries.add(fRanDom_2);
