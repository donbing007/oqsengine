...
public class EntityGenerateToolBar {
    ...
    public static IEntity[] generateFixedEntities(long startId, int version) {
        ...
        entityes[0] = new Entity(id, entityClass, values, new EntityFamily(0, id + 1), version, OqsVersion.MAJOR);
        ...
        entityes[1] = new Entity(id, entityClass, values, new EntityFamily(id - 1, 0), version, OqsVersion.MAJOR);
        ...
        values.addValues(Arrays.asList(new LongValue(longField, 2L), new StringValue(stringField, "hello world"),
            ...
            new DecimalValue(decimalField, new BigDecimal("1.0")), new EnumValue(enumField, "CODE"),
            new StringsValue(stringsField, "value1", "value2", "value3")));
        entityes[2] = new Entity(id, entityClass, values, new EntityFamily(0, 0), version, OqsVersion.MAJOR);
        ...
        values.addValues(Arrays.asList(new LongValue(longField, 76L), new StringValue(stringField, "中文测试chinese test"),
            ...
            new DecimalValue(decimalField, new BigDecimal("1.0")), new EnumValue(enumField, "CODE"),
            new StringsValue(stringsField, "value1", "value2", "value3")));
        entityes[3] = new Entity(id, entityClass, values, new EntityFamily(id + 1, 0), version, OqsVersion.MAJOR);
        ...
        entityes[4] = new Entity(id, entityClass, values, new EntityFamily(0, id - 1), version, OqsVersion.MAJOR);

        id = startId + 5;
        values = new EntityValue(id);
        values.addValues(Arrays.asList(new StringValue(stringField, "A"),
            new DateTimeValue(dateTimeField, LocalDateTime.of(2020, 3, 1, 0, 0, 1))));
        entityes[5] = new Entity(id, entityClass, values, new EntityFamily(0, 0), version, OqsVersion.MAJOR);
        ...
        entityes[6] = new Entity(id, entityClass, values, new EntityFamily(0, 0), version, OqsVersion.MAJOR);
        ...
        entityes[7] = new Entity(id, entityClass, values, new EntityFamily(0, 0), version, OqsVersion.MAJOR);
        ...
        entityes[8] = new Entity(id, entityClass, values, new EntityFamily(0, 0), version, OqsVersion.MAJOR);
        ...
        values.addValues(Arrays.asList(new LongValue(longField, 445L), new StringValue(stringField, "hello world"),
            ...
            new DecimalValue(decimalField, new BigDecimal("1.0")), new EnumValue(enumField, "CODE"),
            new StringsValue(stringsField, "value1", "value2", "value3")));
        entityes[9] = new Entity(id, entityClass, values, new EntityFamily(0, 0), version, OqsVersion.MAJOR);
